  ...
  return (
    <section id="contact" className="py-24">
      <div className="max-w-[1160px] mx-auto px-6">
        ...
        <h2 className="font-grotesk text-5xl font-bold mb-12">Let&apos;s build something useful.</h2>
        <motion.div
        ...
        >
          <div>
            ...
            <a
              ...
              className="font-grotesk text-2xl font-bold text-accent-dark hover:underline break-all"
            >
